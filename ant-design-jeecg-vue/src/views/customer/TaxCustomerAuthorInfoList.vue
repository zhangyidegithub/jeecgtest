  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-dropdown v-if="selectedRowKeys.length > 0">
        <a-menu slot="overlay">
          <a-menu-item key="1" @click="batchDel"><a-icon type="delete" v-has="'customerAuthorInfo:delete'" />删除</a-menu-item>
        </a-menu>
...
<!--          <a-divider type="vertical" />-->
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                <a href="javascript:;" @click="handleDetail(record)" v-has="'customerAuthorInfo:detail'" >详情</a>
              </a-menu-item>
              <a-menu-item>
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)" v-has="'customerAuthorInfo:delete'">
                  <a>删除</a>
                </a-popconfirm>
              </a-menu-item>
            </a-menu>
    ...
    <!-- 表单区域 -->
    <tax-customer-author-info-modal ref="modalForm" @ok="modalFormOk"></tax-customer-author-info-modal>
  </a-card>
</template>
    ...
    data () {
      return {
        ...
        url: {
          ...
          importExcelUrl: "customer/taxCustomerAuthorInfo/importExcel",
        },
      }
    },
    computed: {
